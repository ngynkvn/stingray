...
[![Build Status](https://github.com/ngynkvn/stingray/actions/workflows/ci.yml/badge.svg)](https://github.com/ngynkvn/stingray/actions/workflows/ci.yml)
...
Get the code:
    ...
    go get github.com/ngynkvn/stingray
...
Manta is distributed under the [MIT license](https://github.com/ngynkvn/stingray/blob/master/LICENSE).

## Code of Conduct

Manta has adopted the [Contributor Covenant Code of Conduct](https://github.com/ngynkvn/stingray/blob/master/CONDUCT.md).
